...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cmsplugin_filerteaser', (
            ...
            ('image_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True)),
            ('style', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('use_autoscale', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ...
            ('free_link', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ...
        db.send_create_signal(u'cmsplugin_filer_teaser', ['FilerTeaser'])

        # Adding model 'FilerTeaserList'
        db.create_table(u'cmsplugin_filerteaserlist', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'cmsplugin_filerteaser')

        # Deleting model 'FilerTeaserList'
        db.delete_table(u'cmsplugin_filerteaserlist')

        # Removing M2M table for field filer_teasers on 'FilerTeaserList'
        db.delete_table(db.shorten_name(u'cmsplugin_filerteaserlist_filer_teasers'))
